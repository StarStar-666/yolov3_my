...
def RFB_net(input_data ,trainable, name, stride=1,scale =0.1, activate=True, bn=True):
    ...
    conv_1 = tf.keras.layers.SeparableConv2D(conv, kernel_size=(3, 3), strides=1,padding="same")

    conv_1_1 = conv2d_bn(conv_1, (256,256), 3, 3, dilation_rate=3)

    conv_2_1 = conv2d_bn(conv_1,(256,256), 3,3, dilation_rate=5)
