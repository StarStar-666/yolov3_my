...
__C.TRAIN.ANNOT_PATH          = "/content/drive/MyDrive/voc_2007/data/datset/voc_train.txt"
...
__C.TEST.ANNOT_PATH           = "/content/drive/MyDrive/voc_2007/data/datset/voc_test.txt"
